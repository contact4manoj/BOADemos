...
using BankingProject.WebMvc.DtoModels;
...
[ApiController]
public class CategoriesApiOriginalController : ControllerBase
{
    private readonly ApplicationDbContext _context;
    private readonly ILogger<CategoriesApiOriginalController> _logger;

    public CategoriesApiOriginalController(
        ApplicationDbContext context, 
        ILogger<CategoriesApiOriginalController> logger)
    {
        _context = context;
        _logger = logger;
    }
